...
namespace SENGENSystem.Server.Common.Persistence.Migrations
{
    ...
    [Migration("20260805132530_AddStudentSubjectRecord")]
    partial class AddStudentSubjectRecord
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SENGENSystem.Server.Domain.AdmissionRequirementProgram", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("AdmissionRequirementId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AdmissionRequirementId", "Program")
                        .IsUnique();

                    b.ToTable("AdmissionRequirementPrograms");
                });
            ...
            modelBuilder.Entity("SENGENSystem.Server.Domain.RegistrationDocument", b =>
                {
                    ...
                    b.HasIndex("StudentRegistrationId", "RequirementCode")
                        .IsUnique();
            ...
            modelBuilder.Entity("SENGENSystem.Server.Domain.StudentSubjectRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("StudentRegistrationId", "Verdict");

                    b.HasIndex("StudentRegistrationId", "SubjectId", "SemesterId")
                        .IsUnique();
            ...
            modelBuilder.Entity("SENGENSystem.Server.Domain.SurveyCampaign", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5e2f0a10-0000-4000-8000-000000000001"),
                            IsOpen = true,
                            LastChangedBy = "System",
                            OpenedAtUtc = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            TargetResponses = 30
                        });
                });
            ...
            modelBuilder.Entity("SENGENSystem.Server.Domain.SurveyResponse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SENGENSystem.Server.Domain.SystemSettings", b =>
                {
                    ...
                    b.Property<double>("GapSaturationHours")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("float")
                        .HasDefaultValue(8.0);
                    ...
                    b.Property<int>("MinSectionEnrollment")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(15);

                    b.Property<int>("ScheduleMaxStepsThousands")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(2000);

                    b.Property<int>("ScheduleTimeBudgetSeconds")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(20);
                    ...
                    b.Property<bool>("TermActivationOpen")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);
                    ...
                    b.Property<double>("WeightIdleGap")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("float")
                        .HasDefaultValue(0.34999999999999998);

                    b.Property<double>("WeightPreference")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("float")
                        .HasDefaultValue(0.40000000000000002);

                    b.Property<double>("WeightRoomFit")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("float")
            ...
            modelBuilder.Entity("SENGENSystem.Server.Domain.TermActivation", b =>
                {
                    ...
                    b.Property<int?>("DeclaredYearLevel")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SENGENSystem.Server.Domain.User", b =>
                {
                    ...
                    b.Property<DateTime?>("TwoFactorCodeExpiresUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("SENGENSystem.Server.Domain.AdmissionRequirementProgram", b =>
                {
                    b.HasOne("SENGENSystem.Server.Domain.AdmissionRequirement", "AdmissionRequirement")
                        .WithMany("Programs")
                        .HasForeignKey("AdmissionRequirementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AdmissionRequirement");
                });
            ...
            modelBuilder.Entity("SENGENSystem.Server.Domain.SurveyResponse", b =>
                {
                    b.HasOne("SENGENSystem.Server.Domain.SurveyInvitation", "Invitation")
                        .WithOne("Response")
                        .HasForeignKey("SENGENSystem.Server.Domain.SurveyResponse", "InvitationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
